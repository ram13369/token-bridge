...
const unlock = async (provider, contract, amount, sender, transactionHash) => {
  try {
    const trx = contract.methods.unlockTokens(amount, sender, transactionHash);
