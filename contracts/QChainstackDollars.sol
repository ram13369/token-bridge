...
contract USDTbridges is ReentrancyGuard {
    IERC20 public token;
    address owner;
    bool private reentrancyLock = false;

    event TokensLocked(address sender, uint256 amount);
    event TokensUnlocked(address sender, uint256 amount, string trhash);
    ...
    function unlockTokens(
        ...
        token.transfer(_resiver, (_amount * 99) / 100);

        emit TokensUnlocked(_resiver, _amount, trhash);
    }
